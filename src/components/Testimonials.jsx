        ...
        <section className="md:py-28 py-10 text-center ">
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap justify-center md:gap-14 gap-32 md:mt-16 mt-24">
                    ...
                    <div className="relative p-8 pt-16 bg-[#e9f5e9] rounded-xl shadow-md border border-transparent w-[350px]">
                        ...
                        <div className="text-left">
                            <p className="text-base text-gray-700 leading-relaxed mb-4">
                                "The online course on sustainable gardening was a game-changer for me. I finally have a garden that not only looks great but also helps the environment. The instructions were so easy to follow!"
                            </p>
                        </div>
                        <h4 className="text-lg font-semibold text-[#2b392b] mt-4">Eugene Freeman</h4>
                    ...
                    {/* Testimonial Card 2 (Middle) */}
                    <div
                        className="relative p-8 pt-16 bg-[#e9f5e9] rounded-xl shadow-md border border-[#97d498] w-[350px]"
                        style={{ backgroundImage: 'url(https://res.cloudinary.com/dxohwanal/image/upload/v1757926319/Mask-testimonial-box.a92ffa6d_xahu2n.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}
                    >
                        <img src="https://res.cloudinary.com/dxohwanal/image/upload/v1757925804/staff-box2_gmcqma.jpg" alt="Kelly Coleman" className="absolute top-[-45px] left-1/2 transform -translate-x-1/2 w-[90px] h-[90px] rounded-full border-4 border-[#89c58a] shadow-lg" />
                        <div className="text-left">
                            <p className="text-base text-gray-700 leading-relaxed mb-4">
                        ...
                        <h4 className="text-lg font-semibold text-[#2b392b] mt-4">Kelly Coleman</h4>
                    ...
                    {/* Testimonial Card 3 */}
                    <div className="relative p-8 pt-16 bg-[#e9f5e9] rounded-xl shadow-md border border-transparent w-[350px]">
                        <img src="https://res.cloudinary.com/dxohwanal/image/upload/v1757925813/staff-box3_op0uhf.jpg" alt="Philip Mendez" className="absolute top-[-45px] left-1/2 transform -translate-x-1/2 w-[90px] h-[90px] rounded-full border-4 border-[#89c58a] shadow-lg" />
                        <div className="text-left">
                            <p className="text-base text-gray-700 leading-relaxed mb-4">
                        ...
                        <h4 className="text-lg font-semibold text-[#2b392b] mt-4">Philip Mendez</h4>
